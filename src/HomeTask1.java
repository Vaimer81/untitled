...
//        Given an integer x, return true if x is a palindrome, and false otherwise.
        ...
        System.out.println("заданое число палидром? - " + isPalindromeStr(111));
...
//        and one element appears only once.
        ...
        System.out.println("элемент, появляюшийся в массиве 1 раз - " +
                findSingleElem(new int[]{1, 1, 2, 3, 3, 4, 4,}));

        System.out.println(findSingleElem(new int[]{1, 1, 2, 2, 3, 3, 4, 4}));
